...
void computePairEnergy(/*int * CLeafType_p, int * pNodeType_p, */int * int_array, REAL *rot_p,  REAL * trans_p,   REAL * bv1_m_center_p,  const REAL * bv2_m_center_p,  const REAL * bv1_m_rad_p,  const REAL * bv2_m_rad_p/*, int * size1_p, int * size2_p*/,  REAL * CLeaf_m_rotate_p, REAL * CLeaf_next_m_positions_p,  REAL CLeaf_m_translate_p[3],   REAL  * pNode_m_rotate_p, REAL *  pNode_next_m_positions_p,  REAL  pNode_m_translate_p[3],  REAL *  pNode_m_positions_p,  REAL * CLeaf_m_positions_p,  REAL * CLeaf_m_distances_p/*, int *CLeaf_m_index_p, int * pNode_m_index_p,  int * type1_m_aTypes,  int *type2_m_aTypes, int * type1_m_nGroups_p, int * type2_m_nGroups_p,  int *type1_m_groups,  int  *type2_m_groups*/,  REAL *type1_m_charges_p,  REAL *type2_m_charges_p,  REAL * termSum, int* interaction, short *resetTerm){

#pragma HLS INTERFACE s_axilite port=int_array  bundle=control
//#pragma HLS INTERFACE s_axilite port=pNodeType_p bundle=control
//#pragma HLS INTERFACE s_axilite port=size1_p  bundle=control
//#pragma HLS INTERFACE s_axilite port=size2_p  bundle=control
//#pragma HLS INTERFACE s_axilite port=CLeaf_m_index_p  bundle=control
//#pragma HLS INTERFACE s_axilite port=pNode_m_index_p  bundle=control
//#pragma HLS INTERFACE s_axilite port=type1_m_nGroups_p  bundle=control
//#pragma HLS INTERFACE s_axilite port=type2_m_nGroups_p  bundle=control
#pragma HLS INTERFACE s_axilite port=bv1_m_center_p bundle=control
#pragma HLS INTERFACE s_axilite port=bv2_m_center_p bundle=control
#pragma HLS INTERFACE s_axilite port=termSum bundle=control
#pragma HLS INTERFACE s_axilite port=pNode_next_m_positions_p bundle=control
#pragma HLS INTERFACE s_axilite port=type1_m_charges_p bundle=control
#pragma HLS INTERFACE s_axilite port=pNode_m_translate_p bundle=control
//#pragma HLS INTERFACE s_axilite port=type2_m_groups bundle=control
//#pragma HLS INTERFACE s_axilite port=type2_m_aTypes bundle=control
#pragma HLS INTERFACE s_axilite port=type2_m_charges_p bundle=control
#pragma HLS INTERFACE s_axilite port=rot_p bundle=control
#pragma HLS INTERFACE s_axilite port=CLeaf_m_distances_p bundle=control
#pragma HLS INTERFACE s_axilite port=bv1_m_rad_p bundle=control
#pragma HLS INTERFACE s_axilite port=CLeaf_m_rotate_p bundle=control
//#pragma HLS INTERFACE s_axilite port=type1_m_aTypes bundle=control
#pragma HLS INTERFACE s_axilite port=trans_p bundle=control
#pragma HLS INTERFACE s_axilite port=resetTerm bundle=control
#pragma HLS INTERFACE s_axilite port=bv2_m_rad_p bundle=control
//#pragma HLS INTERFACE s_axilite port=type1_m_groups bundle=control
#pragma HLS INTERFACE s_axilite port=CLeaf_m_positions_p bundle=control
#pragma HLS INTERFACE s_axilite port=CLeaf_m_translate_p bundle=control
#pragma HLS INTERFACE s_axilite port=pNode_m_rotate_p bundle=control
#pragma HLS INTERFACE s_axilite port=CLeaf_next_m_positions_p bundle=control
#pragma HLS INTERFACE s_axilite port=interaction bundle=control
#pragma HLS INTERFACE s_axilite port=pNode_m_positions_p bundle=control
#pragma HLS INTERFACE m_axi port=type1_m_charges_p offset=slave bundle=gmem2
//#pragma HLS INTERFACE m_axi port=type1_m_groups offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=type2_m_groups offset=slave bundle=gmem0
...
#pragma HLS INTERFACE m_axi port=type2_m_charges_p offset=slave bundle=gmem2
//#pragma HLS INTERFACE m_axi port=type2_m_aTypes offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=type1_m_aTypes offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=pNode_m_translate_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=CLeaf_m_positions_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=CLeaf_m_distances_p offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=CLeaf_m_translate_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=pNode_m_rotate_p offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=CLeaf_next_m_positions_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=CLeaf_m_rotate_p offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=pNode_m_positions_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=pNode_next_m_positions_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=bv1_m_center_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=rot_p offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=bv1_m_rad_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=bv2_m_center_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=trans_p offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=bv2_m_rad_p offset=slave bundle=gmem2

//#pragma HLS INTERFACE m_axi port=CLeafType_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=pNodeType_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=size1_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=size2_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=CLeaf_m_index_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=pNode_m_index_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=type1_m_nGroups_p offset=slave bundle=gmem0
//#pragma HLS INTERFACE m_axi port=type2_m_nGroups_p offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=int_array offset=slave bundle=gmem0

    
#pragma HLS INTERFACE s_axilite port=return bundle=control
    /*
    int CLeafType = *CLeafType_p;
    int pNodeType = *pNodeType_p;
    int size1 = *size1_p;
    int size2 = *size2_p;
    int CLeaf_m_index = *CLeaf_m_index_p;
    int pNode_m_index = *pNode_m_index_p;
    int type1_m_nGroups = *type1_m_nGroups_p;
    int type2_m_nGroups = *type2_m_nGroups_p;
    */
...
#pragma HLS PIPELINE
		...
		memcpy(rot, rot_p, 3 *3 * sizeof(REAL));
		memcpy(trans, trans_p, 3 * sizeof(REAL));
		memcpy(bv1_m_center, bv1_m_center_p, 3 * sizeof(REAL));
		memcpy(bv2_m_center, bv2_m_center_p, 3 * sizeof(REAL));
		memcpy(bv1_m_rad, bv1_m_rad_p, sizeof(REAL));
		memcpy(bv2_m_rad, bv2_m_rad_p, sizeof(REAL));
		/*memcpy(CLeaf_m_rotate, CLeaf_m_rotate_p, 3 * 3 * sizeof(REAL));
		memcpy(CLeaf_next_m_positions, CLeaf_next_m_positions_p, 3 * 12 * sizeof(REAL));
		memcpy(CLeaf_m_translate, CLeaf_m_translate_p, 3 * sizeof(REAL));
		memcpy(pNode_m_rotate, pNode_m_rotate_p, 12 * 3 * sizeof(REAL));
		memcpy(pNode_m_translate, pNode_m_translate_p, 3 * sizeof(REAL));
		memcpy(pNode_m_positions, pNode_m_positions_p, 12 * 3 * sizeof(REAL));
		memcpy(CLeaf_m_positions, CLeaf_m_positions_p, 12 * 3 * sizeof(REAL));
		memcpy(CLeaf_m_distances, CLeaf_m_distances_p, MAX_ROTAMER_SIZE * MAX_ROTAMER_SIZE * sizeof(REAL));
		memcpy(type1_m_charges, type1_m_charges_p, 5 * sizeof(REAL));
		memcpy(type2_m_charges, type2_m_charges_p, 12 * sizeof(REAL));
		*/
	...
	*termSum = sum;*/
	*termSum = type1_m_aTypes[2] * type2_m_aTypes[1] * type1_m_groups[0] * type2_m_groups[0] * CLeaf_m_distances[0] * rot [3] * trans[1]*bv1_m_center[0] * bv2_m_center[0] * bv1_m_rad[0]* bv2_m_rad[0];
	//*termSum = 0;
