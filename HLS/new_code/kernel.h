 ...
 */
#define TYPE1_M_ATYPES_DIM 5
#define TYPE2_M_ATYPES_DIM 12
#define TYPE1_M_GROUPS_DIM 1
#define TYPE2_M_GROUPS_DIM 4
#define TYPE1_M_CHARGES_DIM 5
...
*/
void computePairEnergy(/*int * CLeafType_p, int * pNodeType_p, */int * int_array, REAL *rot,  REAL * trans,   REAL * bv1_m_center,  const REAL * bv2_m_center,  const REAL * bv1_m_rad,  const REAL * bv2_m_rad/*, int * size1_p, int * size2_p*/,  REAL * CLeaf_m_rotate, REAL * CLeaf_next_m_positions,  REAL CLeaf_m_translate[3],   REAL  * pNode_m_rotate, REAL *  pNode_next_m_positions,  REAL  pNode_m_translate[3],  REAL *  pNode_m_positions,  REAL * CLeaf_m_positions,  REAL * CLeaf_m_distances/*, int *CLeaf_m_index_p, int * pNode_m_index_p,  int * type1_m_aTypes,  int *type2_m_aTypes, int * type1_m_nGroups_p, int * type2_m_nGroups_p,  int *type1_m_groups,  int  *type2_m_groups*/,  REAL *type1_m_charges,  REAL *type2_m_charges,  REAL * termSum, int* interaction, short *resetTerm);
